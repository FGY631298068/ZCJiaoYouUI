...
@protocol ZJScrollSegmentViewDelegateButton <NSObject>

- (void)ABulletBox:(UIButton *)buttonBox;
...
@property (nonatomic, weak)id<ZJScrollSegmentViewDelegateButton>delegate;
// 所有的标题
